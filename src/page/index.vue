<template>
  <er-row>
    ...
    <div class="bdd_v"><span class="bdd_pl">官网地址</span><span class="bdd_k">https://lanhuapp.com</span></div>
    <div class="bdd_hr"></div>
    ...
    <div class="bdd_ji">
      <div class="bdd_s bdd_color"><span class="bdd_time">注册号</span><span class="bdd_ri">01234567890123401-01</span></div>
    ...
    <div class="bdd_f">该公司有<span class="bdd_size bdd_col" > 000 </span>家分支机构，打开标大大app可查看详情</div>
    <div class="bdd_plone">人员信息</div>
    <div class="bdd_f">该公司有<span class="bdd_size bdd_col" > 000 </span>条人员信息，打开标大大app可查看详情</div>
    <div class="bdd_plone">业绩信息</div>
    <div style="margin-bottom: 64px" class="bdd_f">该公司有<span class="bdd_size" style="color:#CEA63F "> 000 </span>条业绩信息，打开标大大app可查看详情</div>

    <div class="bdd_footer">
      <div class="bdd_one"> <img class="bdd_img" src="../assets/logo.png"/> </div>
      <div class="bdd_two"><div class="bdd_g">标大大</div><div class="bdd_n">打开App了解更多资讯</div></div>
      <div class="bdd_foo"><span class="bdd_x">立即打开</span></div>
    </div>
  </er-row>
</template>
<script>
